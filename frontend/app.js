...
// текст (text-render.js) и панель «Что услышит модель» (text-preview.js). Связь
// двусторонняя: модули зовут перерисовку соседних вкладок через `loadVoices`
// и `renderReplicaCards`, а события их элементов — отсюда.
import {
  cancelJob,
  setPreviewStatus,
  renderVoiceCards,
...
// с микрофона (voice-record.js), сплошной текст (text-render.js) и панель
// «Что услышит модель» (text-preview.js). Списки совпадают с их `import`: модули
