...
// проекта (project-io.js), запись голоса с микрофона (voice-record.js) и сплошной
// текст (text-render.js). Связь двусторонняя: модули зовут перерисовку соседних
// вкладок через `loadVoices`, а события их элементов — отсюда.
import {
  cancelJob,
  setPreviewStatus,
  renderVoiceCards,
...
// с микрофона (voice-record.js) и сплошной текст (text-render.js). Списки совпадают
